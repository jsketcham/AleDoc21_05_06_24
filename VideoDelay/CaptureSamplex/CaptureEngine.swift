...
private class CaptureEngineStreamOutput: NSObject, SCStreamOutput, SCStreamDelegate {
    ...
    let pixelBufferDelay = PixelBufferDelay()
...
//    var delayLine = [CVPixelBuffer]()
//    var ctr = 0
        
    /// Create a `CapturedFrame` for the video sample buffer.
    private func createFrame(for sampleBuffer: CMSampleBuffer) -> CapturedFrame? {
        
        pixelBufferDelay.delay(sampleBuffer.imageBuffer)
...
//        
//        print("CMSampleBuffer copy: failed to get image buffer")
//        return nil
////        fatalError("CMSampleBuffer copy: get image buffer")
//        
//    }
//
...
//    
//    do{
//        format = try CMVideoFormatDescription(imageBuffer: copiedPixelBuffer)//CMSampleBufferGetFormatDescription(self)!
//    }catch{
//        print("CMSampleBuffer copy: format error")
//        return nil
////        fatalError("CMSampleBuffer copy: format error")
//    }
...
//    guard let bufOut = copiedSampleBuffer else {
//        
//        print("CMSampleBuffer copy: CreateReady \(status)")
//        return nil
////        fatalError("CMSampleBuffer copy: CreateReady \(status)")
//        
//    }
//    // status -12743 kCMSampleBufferError_InvalidMediaFormat
//    return bufOut
//  }
//}
