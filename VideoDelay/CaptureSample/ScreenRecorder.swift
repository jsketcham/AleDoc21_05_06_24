...
//            UserDefaults.standard.setValue(videoDelaySeconds, forKey: "videoDelaySeconds")
    ...
    @Published var selectedDisplayIndex : Int = 0{
        didSet{
            ...
            selectedDisplay = availableDisplays[selectedDisplayIndex]
        }
    }
    ...
    /*
     ...
     // set delegate's reference to screenRecorder
    ...
    private func refreshAvailableContent() async {
        do {
            ...
            if selectedDisplay == nil {
                let index = UserDefaults.standard.integer(forKey: "videoSourceSelector") % NSScreen.screens.count
                
                selectedDisplay = availableDisplays[index]//availableDisplays.first
            }
