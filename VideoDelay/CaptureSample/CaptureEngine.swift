...
class CaptureEngine: NSObject, @unchecked Sendable {
    ...
    var delaySeconds : Double = 0.0  // trying out publish/assign
...
//    private var streamOutput : CaptureEngineStreamOutput?
    ...
    override init() {
        super.init()
        print("CaptureEngine init")
        // subscribe to videoDelaySeconds?
...
private class CaptureEngineStreamOutput: NSObject, SCStreamOutput, SCStreamDelegate {
    ...
    // TODO: subscribe to videoDelaySeconds, set pixelBufferDelay.delaySeconds
    ...
    init(continuation: AsyncThrowingStream<CapturedFrame, Error>.Continuation?) {
        ...
        print("CaptureEngineStreamOutput init")
    }
...
//    var ctr = 0
    ...
    private func createFrame(for sampleBuffer: CMSampleBuffer) -> CapturedFrame? {
        ...
        // the double copy of CVPixelBuffer is 4 ms, single NSImage is 3.3 ms,
        // not enough of an improvement to pursue
