...
private class CaptureEngineStreamOutput: NSObject, SCStreamOutput, SCStreamDelegate {
    ...
    static var then : CFTimeInterval?
    static var numFrames = 0
...
//        
//        if let then = CaptureEngineStreamOutput.then{
//            
//            CaptureEngineStreamOutput.numFrames += 1
//            
//            if CaptureEngineStreamOutput.numFrames % 60 == 0{
//                
//                print("elapsed, mod 60 frames: \(now - then)")
//            }
//        }else{
//            
//            CaptureEngineStreamOutput.then = now
//            CaptureEngineStreamOutput.numFrames = 0
//        }
