...
class ScreenRecorder: ObservableObject {
    ...
    @Published var displayIndex : Int = 0{   // the index we want
        didSet{
//            Swift.print("screenRecorder displayIndex \(displayIndex)")
            if availableDisplays.count > displayIndex{
                selectedDisplay = availableDisplays[displayIndex]
            }
